...
the recommended use case is when we unlock SIMD computing though for now this remains useless for blair's hardware

the average throughput for this is around 10 per second AND regularly hits timeout issues despite our generous 10s timeout (very shit compared to our 40 per sec on webpx)
