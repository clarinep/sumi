    ...
    for row_y in (0..height).step_by(2) {
        ...
        unsafe {
            ...
            while col_x + 7 < width {
                ...
                let c0_1 = _mm_cvtsi128_si32(_mm_srli_si128::<4>(p0_0)) as u32;
                let c0_2 = _mm_cvtsi128_si32(_mm_srli_si128::<8>(p0_0)) as u32;
                let c0_3 = _mm_cvtsi128_si32(_mm_srli_si128::<12>(p0_0)) as u32;
                let c0_4 = _mm_cvtsi128_si32(p0_1) as u32;
                let c0_5 = _mm_cvtsi128_si32(_mm_srli_si128::<4>(p0_1)) as u32;
                let c0_6 = _mm_cvtsi128_si32(_mm_srli_si128::<8>(p0_1)) as u32;
                let c0_7 = _mm_cvtsi128_si32(_mm_srli_si128::<12>(p0_1)) as u32;

                let c1_0 = _mm_cvtsi128_si32(p1_0) as u32;
                let c1_1 = _mm_cvtsi128_si32(_mm_srli_si128::<4>(p1_0)) as u32;
                let c1_2 = _mm_cvtsi128_si32(_mm_srli_si128::<8>(p1_0)) as u32;
                let c1_3 = _mm_cvtsi128_si32(_mm_srli_si128::<12>(p1_0)) as u32;
                let c1_4 = _mm_cvtsi128_si32(p1_1) as u32;
                let c1_5 = _mm_cvtsi128_si32(_mm_srli_si128::<4>(p1_1)) as u32;
                let c1_6 = _mm_cvtsi128_si32(_mm_srli_si128::<8>(p1_1)) as u32;
                let c1_7 = _mm_cvtsi128_si32(_mm_srli_si128::<12>(p1_1)) as u32;
                ...
                let r_odd = _mm_srli_si128::<2>(r_sum0);
                ...
                let g_odd = _mm_srli_si128::<2>(g_sum0);
                ...
                let b_odd = _mm_srli_si128::<2>(b_sum0);
                let b_avg = _mm_srli_epi16(_mm_add_epi16(_mm_add_epi16(b_even, b_odd), _mm_set1_epi16(2)), 2);

                let r_avg4 = _mm_set_epi16(0, 0, 0, 0, _mm_extract_epi16::<6>(r_avg) as i16, _mm_extract_epi16::<4>(r_avg) as i16, _mm_extract_epi16::<2>(r_avg) as i16, _mm_extract_epi16::<0>(r_avg) as i16);
                let g_avg4 = _mm_set_epi16(0, 0, 0, 0, _mm_extract_epi16::<6>(g_avg) as i16, _mm_extract_epi16::<4>(g_avg) as i16, _mm_extract_epi16::<2>(g_avg) as i16, _mm_extract_epi16::<0>(g_avg) as i16);
                let b_avg4 = _mm_set_epi16(0, 0, 0, 0, _mm_extract_epi16::<6>(b_avg) as i16, _mm_extract_epi16::<4>(b_avg) as i16, _mm_extract_epi16::<2>(b_avg) as i16, _mm_extract_epi16::<0>(b_avg) as i16);
