...
/// Standard macroblock Intra-prediction mode tree for Partition 0 header encoding in Keyframes (RFC 6386 Section 11.2).
/// Mode indices: 4: B_PRED, 0: DC_PRED, 1: V_PRED, 2: H_PRED, 3: TM_PRED
pub const KF_Y_MODE_TREE: [i8; 8] = [
    -4, 2,  // 4 -> B_PRED, or branch to node 1
    4, 6,   // branch to node 2 (DC/V) or node 3 (H/TM)
    -0, -1, // 0 -> DC_PRED, 1 -> V_PRED
    -2, -3, // 2 -> H_PRED, 3 -> TM_PRED
];

/// Mode probabilities for Keyframe Y Intra prediction (RFC 6386 Section 11.3).
