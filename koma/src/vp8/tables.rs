...
/// 4x4 Zigzag scan coefficient ordering table (RFC 6386 Section 13.3).
pub const ZIGZAG: [usize; 16] = [
    0, 1, 4, 8, 5, 2, 3, 6, 9, 12, 13, 10, 7, 11, 14, 15,
];

/// RFC 6386 Section 9.9 / libwebp band mapping for coefficient indices 0..=15.
pub const KBANDS: [usize; 17] = [
